...
def run_self_test() -> None:
    ...
    # API-facing symbol contract: backend/api/research.py imports these names.
    ...
    missing_api_symbols = [
        name for name in required_api_symbols if name not in globals()
    ]
    assert not missing_api_symbols, (
        f"Missing API schema symbols: {missing_api_symbols}"
    )
